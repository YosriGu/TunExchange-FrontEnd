        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              <ContactInfo icon={<FaEnvelope />} text="support@tunexchange.com" />
              <ContactInfo icon={<FaPhone />} text="+216 1234 5678" />
              <ContactInfo icon={<FaMapMarkerAlt />} text="123 TunEx Street, Tunis 1000, Tunisia" />
            </div>

            <div className="mt-8">
              <h4 className="text-xl font-semibold mb-2 text-[#00df9a] font-rajdhani">Office Hours</h4>
              <p className="font-rajdhani">Monday - Friday: 9:00 AM - 5:00 PM</p>
              <p className="font-rajdhani">Saturday: 10:00 AM - 2:00 PM</p>
              <p className="font-rajdhani">Sunday: Closed</p>
            </div>
          </div>
        </div>
      </div>
